...
(() => {
    ...
    function insertRecord(panelElement, panelBlockElementToInsert) {
        ...
        for (const panelBlockElement of panelBlockElements) {
            if (Number.parseInt(panelBlockElement.dataset.recordCreate_timeMillis ?? '0', 10) <
                Number.parseInt(panelBlockElementToInsert.dataset.recordCreate_timeMillis ?? '0', 10)) {
    ...
    function openEmployeeModal(employeeNumber) {
        ...
        function renderAttendanceRecords(records) {
          ...
          <div class="column">
            ...
            <span class="is-size-7">
              <i class="fas fa-fw ${callOutRecord.isSuccessful ?? false
        ...
        cityssm.openHtmlModal('attendance-employee', {
            ...
            onshown(modalElement) {
                ...
                if (absencesCanView) {
                    reportsPanelElement?.insertAdjacentHTML('beforeend', `<a class="panel-block" href="${Attend.urlPrefix}/reports/absenceRecords-recent-byEmployeeNumber/?employeeNumber=${employeeNumber}" download>
              <div class="columns is-mobile is-variable is-2">
                ...
                if (returnsToWorkCanView) {
                    reportsPanelElement?.insertAdjacentHTML('beforeend', `<a class="panel-block" href="${Attend.urlPrefix}/reports/returnToWorkRecords-recent-byEmployeeNumber/?employeeNumber=${employeeNumber}" download>
              <div class="columns is-mobile is-variable is-2">
                <div class="column is-narrow">
                  <i class="fas fa-2x fa-file" aria-hidden="true"></i>
                </div>
                ...
                if (callOutsCanView) {
                    reportsPanelElement?.insertAdjacentHTML('beforeend', `<a class="panel-block" href="${Attend.urlPrefix}/reports/callOutRecords-recent-byEmployeeNumber/?employeeNumber=${employeeNumber}" download>
              <div class="columns is-mobile is-variable is-2">
                <div class="column is-narrow">
                  <i class="fas fa-2x fa-file" aria-hidden="true"></i>
                </div>
                ...
                if (afterHoursCanView) {
                    reportsPanelElement?.insertAdjacentHTML('beforeend', `<a class="panel-block" href="${Attend.urlPrefix}/reports/afterHoursRecords-recent-byEmployeeNumber/?employeeNumber=${employeeNumber}" download>
              <div class="columns is-mobile is-variable is-2">
                <div class="column is-narrow">
                  <i class="fas fa-2x fa-file" aria-hidden="true"></i>
                </div>
    ...
    function openEmployeeModalByClick(clickEvent) {
        ...
        const employeeNumber = clickEvent.currentTarget.dataset.employeeNumber ??
            '';
