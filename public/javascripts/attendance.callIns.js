...
(() => {
    ...
    function renderAbsenceRecords() {
        ...
        <div class="column">
          <strong data-tooltip="Absence Type">${absenceRecord.absenceType ?? absenceRecord.absenceTypeKey}</strong><br />
    ...
    function renderReturnToWorkRecords() {
        ...
        <div class="column is-4">
          ...
          <span class="is-size-7">${returnToWorkRecord.employeeNumber ?? ''}</span>
        </div>
        <div class="column">
          <strong data-tooltip="Return Shift">${returnToWorkRecord.returnShift ?? '(No Shift)'}</strong><br />
    ...
    function openCallInModal(clickEvent) {
        ...
        const callInType = clickEvent.currentTarget.dataset.callInType ?? '';
