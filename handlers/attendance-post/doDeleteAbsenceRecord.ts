...
export async function handler(
  ...
  const absenceRecord = await getAbsenceRecord(recordId, request.session.user as AttendUser)
  ...
  const success = await deleteAbsenceRecord(recordId, request.session.user as AttendUser)
